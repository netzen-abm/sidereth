...
| D-031 | Authorization and Policy Evaluation is the canonical permission decision boundary | LOCKED | Authorization is provider-neutral, deny-by-default and fail-closed; purpose, resource scope, data classification, jurisdiction, temporal validity and policy conflicts must be explicitly evaluated; authorization remains distinct from authentication, legal authority, human approval, registry membership and execution; AI/agents cannot self-authorize |
